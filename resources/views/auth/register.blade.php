                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('signup.submit') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="firstname" type="text" class="form-control{{ $errors->has('firstname') ? ' is-invalid' : '' }}" firstname="firstname" value="{{ old('firstname') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="inn" type="text" class="form-control{{ $errors->has('inn') ? ' is-invalid' : '' }}" name="inn" value="{{ old('inn') }}" required autofocus>
